...
deps.annotated_A <- dep.annotated_A[dep.annotated_A$DEP.Status != "Not significant", ]
deps.annotated_H <- dep.annotated_H[dep.annotated_H$DEP.Status != "Not significant", ]

# Write DEP tables to files
write.table(deps.annotated_A, file = "DEP_A549_annotated.csv", 
            sep = "\t", row.names = FALSE, quote = FALSE)

write.table(deps.annotated_H, file = "DEP_H2009_annotated.csv", 
            sep = "\t", row.names = FALSE, quote = FALSE)
...
ggsave("Images/VolcanoPlot_H2009.png",
       width = 6000, height = 4500, dpi = 600, units = "px") 
